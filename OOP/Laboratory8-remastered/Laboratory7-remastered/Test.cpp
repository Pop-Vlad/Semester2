...
void Test::fileLocation() {
	FileRepository repository{};
	Controller controller{ &repository };
	controller.setMode('B');
	controller.changeFile("C:/Users/popvl/source/OOP/Laboratory7-remastered/Tests/path/TestFile_1.txt");
	...
	assert(controller.listAll().size() == 4);
	controller.changeFile("C:/Users/popvl/source/OOP/Laboratory7-remastered/Tests/path/TestFile_3.txt");
	assert(controller.listAll().size() == 4);
	controller.changeFile("../Tests/some path with spaces/TestFile_1.txt");
	assert(controller.listAll().size() == 12);
	controller.changeFile("../Tests/some path with spaces/some file with different extension.abc");
	assert(controller.listAll().size() == 4);
	controller.changeFile("../Tests/some path with spaces/some file with different extension.abc");
	assert(controller.listAll().size() == 4);
	controller.changeFile("C:/Users/popvl/source/OOP/Laboratory7-remastered/Tests/path/TestFile_1.txt");
