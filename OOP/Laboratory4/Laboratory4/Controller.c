...
void registerOperation(controller* controller_pointer, GenericElement new_operation) {
	...
	if (controller_pointer->operation_list_capacity >= controller_pointer->operation_list_capacity) {
		controller_pointer->operation_list_capacity = (int)controller_pointer->operation_list_capacity * 1.5 * (sizeof(GenericElement));
		controller_pointer->operations_list = (GenericElement*)realloc(controller_pointer->operations_list, controller_pointer->operation_list_capacity);
	}
